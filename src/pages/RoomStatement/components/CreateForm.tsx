...
const MeterReadingForm: React.FC<MeterReadingFormProps> = ({
  onSubmit,
  onCancel,
}) => {
  ...
  const roomList = useBuildingStore.getState().roomList;
  ...
  return (
    <Card className="w-full border-none shadow-none bg-white">
      <CardHeader className="border-b border-gray-200">
        <CardTitle className="text-3xl text-themeColor font-semibold text-center">
          Nhập Chỉ Số Đồng Hồ
        </CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="w-full px-8 py-2 mt-2  flex flex-row">
            <div className="flex flex-col w-1/2 gap-2">
              <span>Chọn tòa nhà</span>
              <div>
                <Select
                  onValueChange={(value) => {
                    // Tìm building dựa trên id được chọn
                    const selected =
                      buildingList.find((building) => building.id === value) ||
                      null;
          ...
          <Tabs defaultValue="electricity" className="w-full">
            <TabsList className="flex space-x-4 mb-8 border border-gray-200">
              <TabsTrigger
                value="electricity"
                className="flex-1 py-2 text-center data-[state=active]:bg-themeColor data-[state=active]:text-white text-gray-700 focus:text-themeColor rounded-md  transition duration-200"
              >
                Đọc Công Tơ Điện
              </TabsTrigger>
              <TabsTrigger
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col">
                      ...
                      <Input
                        ...
                        aria-describedby={
                          errors.electricity_old
                            ? "electricity_old-error"
                            : undefined
                        }
                      />
                      {errors.electricity_old && (
                        <span
                          id="electricity_old-error"
                    ...
                    <div className="flex flex-col">
                      ...
                      <Input
                        ...
                        aria-describedby={
                          errors.electricity_new
                            ? "electricity_new-error"
                            : undefined
                        }
                      />
                      {errors.electricity_new && (
                        <span
                          id="electricity_new-error"
                          className="text-red-500 text-sm mt-1"
                        >
                          {errors.electricity_new}
                        </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col">
                      ...
                      <Input
                        ...
                        aria-describedby={
                          errors.water_old ? "water_old-error" : undefined
                        }
                      />
                      {errors.water_old && (
                        <span
                  ...
                  <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
                    ...
                    <div className="flex justify-between">
                      <p className="text-gray-600">
                        ...
                        {Math.max(
                          0,
                          meterReading.water_new - meterReading.water_old
                        )}{" "}
                      </p>
                      <p className="text-gray-600">
                        <span className="font-medium">Tổng Chi Phí: </span>
